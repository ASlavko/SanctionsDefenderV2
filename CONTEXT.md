...
The project supports two operational modes: a single agent and a multi-agent swarm, integration with the SanctionDefenderV2 system.

### 3.1. SanctionDefenderV2 Architecture
The core application is a sanction screening system built with FastAPI and PostgreSQL.
...
### 3.2. Single Agent Mode (`src/agent.py`)
